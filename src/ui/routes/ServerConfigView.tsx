                        ...
                        >
                            <TextArea
                                ...
                                onChange={(e) => {
                                    ...
                                    setEditing({ ...editing, allowIPv4CidrRanges: parseMultilineConfigValue(newValue) ?? undefined });
                                }}
                                rows={3}
                                intent={invalidAllowIPv4CidrRanges ? Intent.DANGER : Intent.NONE}
                            />
                        ...
                        >
                            <TextArea
                                ...
                                onChange={(e) => {
                                    ...
                                    setEditing({ ...editing, allowIPv6CidrRanges: parseMultilineConfigValue(newValue) ?? undefined });
                                }}
                                rows={3}
                                intent={invalidAllowIPv6CidrRanges ? Intent.DANGER : Intent.NONE}
                            />
                        ...
                        >
                            <TextArea
                                ...
                                onChange={(e) => {
                                    ...
                                    setEditing({ ...editing, allowOrigins: parseMultilineConfigValue(newValue) as string[] });
                                }}
                                rows={3}
                            />
                        </FormGroup>
                        ...
                        >
                            <InputGroup
                                ...
                                onChange={(e) => {
                                    ...
                                    if (newValue === "") {
                                        setEditing({ ...editing, tsplayEndpoint: null as unknown as string });
                                    } else {
