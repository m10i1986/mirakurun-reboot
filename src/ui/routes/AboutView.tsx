                    ...
                    <Card elevation={Elevation.ONE} className="about-card">
                        ...
                        <div className="about-info">
                            <table className="bp5-html-table bp5-html-table-striped bp5-html-table-condensed info-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Copyright</td>
                                        <td>Copyright &copy; 2026 <a href="https://github.com/m10i1986" target="_blank" rel="noreferrer">MINETA "m10i" Hiroki</a><br></br>
                                            Copyright &copy; 2016-2026 <a href="https://github.com/kanreisa" target="_blank" rel="noreferrer">kanreisa</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div className="links">
                            <Button
                                ...
                                onClick={() => window.open("https://github.com/m10i1986/mirakurun-reboot", "_blank")}
                                variant="minimal"
                            />
                            <Button
                                icon="git-branch"
                                text="Original GitHub Repository"
