...
export class LazyCaller<T extends (...args: any[]) => any> {
    caller: T;
     ...
     */
    constructor(
        public msDelay: number,
        public msSleep: number,
        public fn: T,
    ) {
    ...
    destroy() {
        ...
        this._activate = null;
        delete (this as Partial<LazyCaller<T>>).fn;
        delete (this as Partial<LazyCaller<T>>).caller;
    }
}
