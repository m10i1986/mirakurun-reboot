                ...
                switch (d.descriptor_tag) {
                    ...
                    case 0x50:
                        ...
                        _.program.set(state.programId, {
                            video: {
                                type:
                                    <apid.ProgramVideoType>(
                                        STREAM_CONTENT[d.stream_content as keyof typeof STREAM_CONTENT]
                                    ) || null,
                                resolution:
                                    <apid.ProgramVideoResolution>(
                                        COMPONENT_TYPE[d.component_type as keyof typeof COMPONENT_TYPE]
                                    ) || null,
                    ...
                    case 0xc4: {
                        ...
                        state.audio._audios[d.component_tag] = {
                            ...
                            samplingRate: SAMPLING_RATE[
                                d.sampling_rate as keyof typeof SAMPLING_RATE
                            ] as apid.ProgramAudioSamplingRate,
                            langs,
                        };
...
function getLangCode(buffer: Buffer): apid.ProgramAudioLanguageCode {
    for (const code in ISO_639_LANG_CODE) {
        if (ISO_639_LANG_CODE[code as keyof typeof ISO_639_LANG_CODE].compare(buffer) === 0) {
...
function getRelatedProgramItem(this: any, event: any): apid.ProgramRelatedItem {
    return {
